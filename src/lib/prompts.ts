...
export const guideMessages = (
    ...
    content: dedent`
      {
        ...
        2: { "name": "플라스틱 장난감", "guide": ["일반쓰레기로 배출해요."], "reference": ["플라스틱 장난감"] }
      }
    `
  },
  {
  ...
  },
  {
    ...
    content: dedent`
      {
        1: { "name": "소형 가전제품", "guide": ["제품이 쓸만하면 중고품으로 재사용되도록 팔거나 지역별 재활용센터로 보내요. 상태와 사용 기간에 따라 돈을 받거나 무상으로 넘길 수 있어요.", "재사용이 어려운 경우 새 제품을 살때 기존 제품을 회수 요청해요. 생산자의 무상방문수거 서비스를 이용해요.", "크다면 대형 쓰레기로 배출 신고를 하고 수수료를 지불할 수 있어요."], "reference": ["소형 가전제품"] }
      }
    `
  },
  {
